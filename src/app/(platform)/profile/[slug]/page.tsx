    ...
    return (
      <div className="space-y-8">
        <PageHeader
          ...
          actions={
            <Badge variant="outline">{profile.profileVisibility === ProfileVisibility.PRIVATE ? "Private profile" : "Public profile"}</Badge>
          }
        />
        ...
        <Card className="glass-panel-strong">
          <CardHeader>
            ...
            <CardDescription>
              The owner can still view their full profile from personal settings. Admins keep access for moderation and support.
            </CardDescription>
          </CardHeader>
          <CardContent>
